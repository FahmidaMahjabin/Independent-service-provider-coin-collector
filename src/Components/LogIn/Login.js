    ...
    return (
        <div className="formContainer my-5">
            ...
            <form>
                ...
                <button className='btn btn-warning d-block w-75' type="button">Log In</button>
            </form>
            <hr></hr>
            <h3>Log In using third party</h3>
            <div>
                <button className='btn d-block w-75 bg-warning my-2' onClick={createUserUsingGoogle}  type="button" >
                ...
                <button className='btn d-block w-75 bg-warning' onClick={createuserUsingFacebook} type="button">
                    <div className='d-flex align-items-center'>
