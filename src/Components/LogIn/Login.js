...
const Login = () => {
    ...
    return (
        <div className="formContainer my-5 text-center">
            ...
            <div>
                <button className='btn d-block w-75 bg-warning my-2 mx-auto' onClick={createUserUsingGoogle}  type="button" >
                ...
                <button className='btn d-block w-75 bg-warning mx-auto' onClick={createuserUsingFacebook} type="button">
                    <div className='d-flex align-items-center'>
