    ...
    return (
        <div className="formContainer my-5">
            ...
            <form onSubmit={createGoogleUser}>
                ...
                <button className='btn btn-warning d-block w-75' type="submit">Register</button>
            </form>
            <hr></hr>
            <h3>Log In using third party</h3>
            <div>
                <button className='btn d-block w-75 bg-warning' type="button" onClick={createUserUsingGoogle} >
                ...
                <button className='btn d-block w-75 bg-warning my-2' type="button">
                    <div className='d-flex align-items-center'>
