...
const Register = () => {
    ...
    const {createUserUsingGoogle, createuserUsingFacebook, googleError, facebookError} = useToSignInWithThirdParty();
    ...
    return (
        <div className="formContainer my-5 text-center">
            ...
            <div>
                <button className='btn d-block w-75 bg-warning mx-auto' type="button" onClick={registerWithGoogle} >
                ...
                <button className='btn d-block w-75 bg-warning my-2 mx-auto' type="button" onClick={registerWithFacebook}>
                    <div className='d-flex align-items-center'>
